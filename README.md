...
- `Java JWT 4.4.0`
- `JPA 7.2.7.Final`
### 7. ESTE PROYECTO FUE REALIZADO POR ABRAHAM ROMAN RAMIREZ Y PUEDE SER ENCONTRADO EN [GITHUB](https://github.com/Satoxehclim/API_SPRINGBOOT) PARA VERIFICAR TODOS LOS CAMBIOS Y VERSIONES DE DESARROLLO
